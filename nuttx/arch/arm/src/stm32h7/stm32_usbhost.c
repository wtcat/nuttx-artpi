...
static const struct stm32_usbhost_trace_s g_trace1[] =
{
#ifdef HAVE_USBHOST_TRACE
...
static const struct stm32_usbhost_trace_s g_trace2[] =
{
#ifdef HAVE_USBHOST_TRACE
 ...
 ********************************************************************************************************************/
#ifndef TRACE1_NSTRINGS
#define TRACE1_NSTRINGS (sizeof(g_trace1) / sizeof(g_trace1[0]))
#endif
#ifndef TRACE2_NSTRINGS
#define TRACE2_NSTRINGS (sizeof(g_trace2) / sizeof(g_trace2[0]))
#endif
/********************************************************************************************************************
 * Public Functions
 ********************************************************************************************************************/

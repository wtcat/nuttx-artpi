 ...
 ****************************************************************************/
//  #define BOARD_SDRAM1_SIZE 0x2000000
...
#define STM32_RCC_D2CFGR_D2PPRE1  RCC_D2CFGR_D2PPRE1_HCLKd4       /* PCLK1 = HCLK / 2 */
#define STM32_PCLK1_FREQUENCY     (STM32_HCLK_FREQUENCY/2)

/* APB2 clock (PCLK2) is HCLK/2 (120 MHz) */

#define STM32_RCC_D2CFGR_D2PPRE2  RCC_D2CFGR_D2PPRE2_HCLKd4       /* PCLK2 = HCLK / 2 */
...
/* Init 400kHz, PLL1Q = 480M / 2,  PLL1Q/(2*300) */

#define STM32_SDMMC_INIT_CLKDIV     (600 << STM32_SDMMC_CLKCR_CLKDIV_SHIFT)

/* Just set these to 25 MHz for now,
 * PLL1Q/(2*4), for default speed 12.5MB/s
 */

#define STM32_SDMMC_MMCXFR_CLKDIV   (10 << STM32_SDMMC_CLKCR_CLKDIV_SHIFT)
#define STM32_SDMMC_SDXFR_CLKDIV    (10 << STM32_SDMMC_CLKCR_CLKDIV_SHIFT)
...
#define BOARD_LED_GREEN (GPIO_OUTPUT|GPIO_SPEED_25MHz|GPIO_PORTI|GPIO_PIN8)  /* PI8 */
#define BOARD_LED_RED   (GPIO_OUTPUT|GPIO_SPEED_25MHz|GPIO_PORTC|GPIO_PIN15) /* PC15 */
...
#define DMAMAP_USART1_TX  DMAMAP_DMA12_USART1TX_0
...
#define GPIO_SPI1_NSS  (GPIO_OUTPUT|GPIO_SPEED_25MHz|GPIO_PUSHPULL|GPIO_PORTA|GPIO_PIN4)//GPIO_SPI1_NSS_2  /* PA4 */
...
/* Wireless (WIFI) */
#define GPIO_WL_REG_ON    (GPIO_OUTPUT|GPIO_SPEED_25MHz|GPIO_PUSHPULL|GPIO_PORTC|GPIO_PIN13)
#define GPIO_WL_HOST_WAKE  

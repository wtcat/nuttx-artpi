...
static void stm32_board_leds_initialize(void) {
	stm32_configgpio(BOARD_LED_RED);
	stm32_configgpio(BOARD_LED_GREEN);
	stm32_gpiowrite(BOARD_LED_RED, 0);
	stm32_gpiowrite(BOARD_LED_GREEN, 1);
}
#endif

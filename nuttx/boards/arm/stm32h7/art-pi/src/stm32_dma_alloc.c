...
#define BOARD_DMA_ALLOC_POOL_SIZE (256 * 512)
#define BOARD_DMA_ALIGNED_SIZE 32
...
static uint8_t g_dma_heap[BOARD_DMA_ALLOC_POOL_SIZE] locate_data(".dmabuf.dma") 
	aligned_data(BOARD_DMA_ALIGNED_SIZE);
...
int stm32_dma_alloc_init(void) {
	memset(g_dma_heap, 0, sizeof(g_dma_heap));
	dma_allocator = gran_initialize(g_dma_heap, sizeof(g_dma_heap),
